@if(isset($prueba))
    ...
    <form action="{{route('prueba.update',$prueba->id)}}" role="form" autocomplete="off" enctype="multipart/form-data" method="POST">
        <input type="hidden" name="_method" value="PUT">
        <input type="hidden" name="_token" value="{{ csrf_token() }}">
        <input type="text" class="hide" name="img" value="{{$prueba->url}}">
